...
action_23=Action.find_or_create_by(name: "Votar Pregunta Negativo", points: 4)
action_24=Action.find_or_create_by(name: "Votar Respuesta Negativo", points: 5)
action_25=Action.find_or_create_by(name: "Votar Comentario Negativo", points: 6)
action_26=Action.find_or_create_by(name: "Comentar Pregunta", points: 7)
action_27=Action.find_or_create_by(name: "Comentar Respuesta", points: 8)
action_28=Action.find_or_create_by(name: "Responder Pregunta", points: 9)
action_29=Action.find_or_create_by(name: "Denunciar Pregunta", points: 10)
action_30=Action.find_or_create_by(name: "Denunciar Respuesta", points: 11)
action_31=Action.find_or_create_by(name: "Denunciar Comentario", points: 12)
