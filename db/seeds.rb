...
puts "Creo Acciones"
action_1=Action.find_or_create_by(name: "Votar Positvo", points: 3)
action_2=Action.find_or_create_by(name: "Votar Negativo", points: -1)

level_2.actions << action_1
level_2.actions << action_2
level_1.actions << action_1
